...
function ennoshita_get_service_sample_data($slug) {
    $data = [
        ...
        'organization' => [
            'number'         => 'SERVICE 03',
            'overview'       => "部署間の壁を越えた対話を促進し、自律的に課題を解決できる組織づくりを支援します。\n\nチームの関係性の質を高めることで、思考の質・行動の質・結果の質が連鎖的に向上する「成功の循環モデル」に基づいたアプローチを採用。ワークショップ・ファシリテーション・コーチングを組み合わせ、組織の自走力を高めます。",
            'targets'        => "部署間のコミュニケーションが不足し、サイロ化している\n会議で本音が出ず、表面的な議論で終わってしまう\n組織の一体感がなく、ビジョンが浸透していない\nチームの心理的安全性を高めたい\n組織変革を進めたいが、社内の抵抗が大きい\n経営層と現場の認識にギャップがある",
            'programs'       => "組織診断・課題可視化|組織サーベイとインタビューを通じて、組織の「見えない課題」を構造的に可視化します。|2〜3週間|経営陣・人事部門\nビジョン共有ワークショップ|経営層と社員が対話を通じてビジョンを共有し、自分ごと化するワークショップ。|1日間|全社員・部門単位\nチームコーチング|チームの関係性の質を高め、自律的な課題解決力を養うチーム単位のコーチングプログラム。|3〜6ヶ月（月1-2回）|チーム単位\n組織変革ファシリテーション|大規模な組織変革プロジェクトのファシリテーション。ステークホルダーの巻き込みから実行まで伴走。|6ヶ月〜1年|経営陣・プロジェクトチーム\n心理的安全性向上プログラム|Google「プロジェクトアリストテレス」の知見に基づき、心理的安全性の高いチームづくりを支援。|3ヶ月|チーム・部門単位",
            'outcomes'       => "部署間の連携が強化され、プロジェクトのリードタイムが短縮\n会議で建設的な議論ができるようになり、意思決定の質が向上\n社員エンゲージメントスコアが導入前比で25ポイント向上\n組織のビジョン浸透度が30%→80%に改善\n自発的な改善提案が前年比3倍に増加",
            'timeline'       => "組織診断|2〜3週間|サーベイ・インタビューによる現状把握と課題の構造化\nプログラム設計|2〜3週間|診断結果に基づくオーダーメイドの支援プログラムを設計\n介入フェーズ|3〜6ヶ月|ワークショップ・コーチング・ファシリテーションを実施\n定着・自走化|1〜3ヶ月|組織内ファシリテーターの育成、自走化の仕組みづくり",
            'case_company'   => 'サービス業 C社様（従業員500名）',
            'case_challenge' => "3つの事業部がそれぞれ独立して動いており、部署間の連携が取れていなかった。全社的なビジョンが浸透しておらず、「うちの部署は関係ない」という空気が蔓延。経営層は危機感を持っていたが、現場との温度差が大きかった。",
            'case_solution'  => "まず組織診断で課題を可視化。その後、経営層と各部門のキーパーソンを集めたビジョン共有ワークショップを3回実施。さらに、部門横断のプロジェクトチームを組成し、6ヶ月間のチームコーチングで連携の仕組みを構築。",
            'case_result'    => "部門横断プロジェクトが定着し、新サービスの開発リードタイムが40%短縮。社員エンゲージメントスコアが62点→87点に大幅向上。「会社のビジョンを理解している」と回答した社員が32%→78%に。",
            'case_quote'     => '最初は「また外部のコンサルか」という冷ややかな反応でしたが、丁寧に現場の声を聴いてくれたことで信頼関係が生まれました。部署間の壁が本当に薄くなったと実感しています。',
            'faq'            => "組織開発とは具体的に何をするのですか？|チームの関係性の質を高め、対話・協働・自律性を促進するアプローチです。ワークショップ、コーチング、ファシリテーション等の手法を組み合わせて実施します。\n効果が出るまでどれくらいかかりますか？|組織の規模や課題の深さによりますが、3〜6ヶ月で変化の兆しが見え始め、1年で定着するケースが多いです。\n社員の反発が心配です。大丈夫でしょうか？|変革には一定の抵抗が伴いますが、「押しつけ」ではなく「対話」を通じて進めるため、社員自身が当事者として参加する設計にしています。\n経営層だけでなく現場も巻き込めますか？|はい。むしろ現場の巻き込みが成功の鍵です。経営層のコミットメントと現場の主体性、両方を引き出すプログラム設計を行います。\nオンラインでも組織開発は可能ですか？|はい。オンラインワークショップやバーチャルチームコーチングの実績があります。対面とオンラインを組み合わせたハイブリッド形式も効果的です。",
        ],
    ];
